...
tags: [deloitte, human-capital-trends, capstone, hr-tech-governance, agent-governance, work-redesign, executive-survey, meta-analysis]
company: _글로벌 9,000명 임원 서베이 (89개국)_
industry: [all]
region: [global]
employee_class: [all]
vendor: [Deloitte]
...
```mermaid
flowchart LR
    Survey[9,000명 임원 서베이 89개국] --> Analysis[3축 긴장 분석]
    Analysis --> W1[Workforce: 사람+에이전트]
    Analysis --> W2[Workplace: 물리+디지털]
    Analysis --> W3[Worker: 개인+조직]
    W1 -->|tipping point| Gov[Agent Governance — HR 신규 역할]
    W2 -->|tipping point| Amb[Engineered Ambiguity]
    W3 -->|tipping point| Redesign[Intentional Work Redesign]
    Gov --> ROI[AI ROI 격차 — 60% vs 5%]
    Redesign --> ROI
```
